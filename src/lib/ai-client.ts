/**
 * Client-side AI generation module.
 * Calls MiniMax API directly from the browser (no server proxy).
 * This avoids Vercel's 10-second serverless function timeout.
 */

import { Template, FormData } from './types'

// Config is imported at build time — Next.js bundles it into the client JS
